...
def Temprature(geometry):
    date_components = input('Enter the start date formatted as YYYY-MM-DD: ').split('-')
    ...
    date_components = input('Enter the end date formatted as YYYY-MM-DD: ').split('-')
    year, month, day = [int(item) for item in date_components]
...
def DissolvedOrganicMatter(geometry):
    date_components = input('Enter the start date formatted as YYYY-MM-DD: ').split('-')
    year, month, day = [int(item) for item in date_components]
